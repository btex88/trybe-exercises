...
// In this case the console.log will apear in the same order as they ware created.
...
// Since there is a setTimeout function in place. The order of execution will be follow by the least delay to the most.
...
(() => {
  ...
  const sendMarsTemperature = (callback) => {
    const msg = `Mars temperature is: ${callback()} degree Celsius`
    setTimeout(() => {
      console.log(msg);
    }, messageDelay());
  };
