...
Exercício 01
  ...
  - Passe sua função como parâmetro da HOF newEmployees   OK!!  para criar cada pessoa contratada em seu respectivo id . OK!!! 
...
const novoFuncionario = (nomeCompleto) => {
  const defaultEmail = `${nomeCompleto.toLowerCase().split(' ').join('_')}`
  const email = `${defaultEmail}@trybe.com`;
